...
export class TaskCreatedEvent extends BaseEvent {
  constructor(public readonly data: Task, actorId?: string) {
    super(actorId);
  }
}

export class TaskUpdatedEvent extends BaseEvent {
  constructor(public readonly data: { before: Task, after: Task }, actorId?: string) {
    super(actorId);
  }
}

export class TaskDeletedEvent extends BaseEvent {
  constructor(public readonly data: { id: string }, actorId?: string) {
    super(actorId);
  }
}
